package com.vergil.mvvmlazy.ext.util

import com.vergil.mvvmlazy.utils.common.KLog

const val TAG = "MvvmLazy"
...
private fun log(level: LEVEL, tag: String, message: String) {
    ...
    when (level) {
        LEVEL.V -> KLog.v(tag, message)
        LEVEL.D -> KLog.d(tag, message)
        LEVEL.I -> KLog.i(tag, message)
        LEVEL.W -> KLog.w(tag, message)
        LEVEL.E -> KLog.e(tag, message)
    }
}