package com.vergil.mvvmlazy.base.fragment
...
import com.vergil.mvvmlazy.base.BaseViewModel.ParameterField
import com.vergil.mvvmlazy.base.ContainerActivity
import com.vergil.mvvmlazy.base.IBaseView
...
abstract class BaseVmFragment<VM : BaseViewModel> : Fragment(), IBaseView {
    ...
    private fun <T: ViewModel> getVmClazz(obj: Any): Class<T> {
