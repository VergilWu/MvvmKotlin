...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  public List<DataBinderMapper> collectDependencies() {
    ...
    result.add(new com.vergil.base.DataBinderMapperImpl());
    result.add(new com.vergil.mvvmlazy.DataBinderMapperImpl());
    return result;
  }
  ...
  private static class InnerBrLookup {
    ...
    static {
      sKeys.put(0, "_all");
      sKeys.put(1, "enableRefresh");
      sKeys.put(2, "layoutManagerFactory");
      sKeys.put(3, "lineManagerFactory");
